...
public class StutdentManagerApp {

    private static final Logger log = LoggerFactory.getLogger(StutdentManagerApp.class);

    private final Environment env;

    public StutdentManagerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes stutdentManager.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(StutdentManagerApp.class);
